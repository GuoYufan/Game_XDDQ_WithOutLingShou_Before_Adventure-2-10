...
def 找到面板基值(attr):
    ...
    面板_鸾鸟=(25818,3921,638)
    面板_天马=(23672,3602,584)
...
def run():
    我=Role([28801,4345,708,869],"我")
    敌=Role([83422,3615,1203,1026],"敌")
    # 30级鸾鸟
    我.主灵兽名称=("鸾鸟","天马")[0]   
    战场=Fight(我,敌)       
    我.现阶段=我.对手.现阶段="金丹"
    ...
    可选主灵兽=使所有灵兽升级到消耗相同灵果(37,"鸾鸟",可选主灵兽)
    input(f"{可选主灵兽}\n😋\n")
